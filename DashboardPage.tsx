import { Grid, GridItem, SimpleGrid, Box, Text, VStack, HStack, Badge, Spinner, Alert, AlertIcon } from '@chakra-ui/react';
...
export const DashboardPage = () => {
  ...
  return (
    <AppShell title="Dashboard Overview" inventoryAlertsCount={data?.inventoryAlertsCount}>
      {isLoading ? (
        <Spinner />
      ) : error ? (
        ...
        <Grid templateColumns={{ base: '1fr', xl: '2fr 1fr' }} gap={6}>
          <GridItem>
            ...
            <Box bg="white" borderRadius="xl" borderWidth="1px" borderColor="gray.100" p={6} mb={6}>
            ...
            <Box bg="white" borderRadius="xl" borderWidth="1px" borderColor="gray.100" p={6}>
              <Text fontSize="lg" fontWeight="semibold" mb={4}>
                Recent Completed Work Orders
              </Text>
              <VStack align="stretch" spacing={4}>
                {data.recentCompletedWorkOrders.length === 0 ? (
                  <Text color="gray.500">No work orders completed in the last 30 days.</Text>
                ) : (
              ...
              <Box bg="white" borderRadius="xl" borderWidth="1px" borderColor="gray.100" p={6}>
                ...
                <VStack align="stretch" spacing={3}>
                  {data.topWorkers.length === 0 ? (
                    <Text color="gray.500">No technician activity recorded yet.</Text>
                  ) : (
              ...
              <Box bg="white" borderRadius="xl" borderWidth="1px" borderColor="gray.100" p={6}>
                ...
                <VStack align="stretch" spacing={3}>
                  {data.lowStockItems.length === 0 ? (
                    <Text color="gray.500">All inventory levels are healthy.</Text>
                  ) : (
